    ...
    <form method="POST" action="{{ route('brand.store') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="negara_asal" id="negara_asal"
                class="form-control @error('negara_asal') is-invalid @enderror" value="{{ old('negara_asal') }}">
